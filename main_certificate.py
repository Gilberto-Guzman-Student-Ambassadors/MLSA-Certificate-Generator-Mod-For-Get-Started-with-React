...
host_Name = "José Gilberto Guzmán Gutiérrez"

# Enter event name
event_Name = "Get Started with React"

# Enter event date
event_date = "June 20th, 2024"
...
# process data
create_cert_files(
    certificate_file, list_participants, host_Name, event_Name, event_date
)
